...
ggplot(df, aes(x = x, y = value, color = variable)) +
  ...
  scale_color_manual(name = 'Correlations', 
                     labels = list(TeX('$r_{Major, Pre} = 
r_{Major, X} =  r_{Pre, X} = 0.2$'), 
                                   TeX('$r_{Major, Pre} = 
r_{Pre, X} = 0.2$, $r_{Major, X} = -0.2$'), 
                                   TeX('$r_{Major, Pre} = 
r_{Major, X} = r_{Pre, X} = 0.4$'), 
                                   TeX('$r_{Major, Pre} = 
r_{Pre, X} = 0.2$, $r_{Major, X} = 0.6$')), 
                     values = c('#2271B2', '#359B73', '#F748A5', '#D55E00'), 
                     guide = guide_legend(title = '', nrow = 4)) +
